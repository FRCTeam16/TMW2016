...
std::shared_ptr<DigitalInput> RobotMap::driveBaseProximityLeft;
std::shared_ptr<DigitalInput> RobotMap::driveBaseProximityRight;
std::shared_ptr<Relay> RobotMap::flashlightRelay;
...
void RobotMap::init() {
	...
	driveBaseProximityLeft.reset(new DigitalInput(0));
	lw->AddSensor("Drive Base", "ProximityLeft", driveBaseProximityLeft);
	driveBaseProximityRight.reset(new DigitalInput(1));
	lw->AddSensor("Drive Base", "ProximityRight", driveBaseProximityLeft);

	flashlightRelay.reset(new Relay(0, Relay::kForwardOnly ));
	flashlightRelay->Set(Relay::kOff);
}
